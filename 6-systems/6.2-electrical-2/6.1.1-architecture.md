...
{% tabs %}
{% tab title="Switches" %}
<figure><img src="../../.gitbook/assets/HVKBW-Networking Switch Layout.drawio (1).svg" alt=""><figcaption><p>Networking Switch Layout</p></figcaption></figure>

{% file src="../../.gitbook/assets/HVKBW-Networking Switch Layout.drawio (1).svg" %}
Networking Switch Layout with Airtable Asset Links
{% endfile %}
{% endtab %}
