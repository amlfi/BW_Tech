...
* Drag the edges to stretch or resize the viewing window OR right-click and select Transform>Fit to Screen and adjust the ShowTouch program window itself until it fills the screen in OBS.
* If the red outline disappears, try dragging the entire preview window slightly — it will reappear.<br>
