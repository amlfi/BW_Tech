...
* **1.1 Welcome**\\
  Landing page with an overview of the wiki's purpose and quick links
* **1.2 About**\\
  How to use this resource, navigation, and update procedures
* **1.3 Outline**\\
  Breakdown of wiki chapters and sections
...
_Procedures for managing emergencies and technical issues_
