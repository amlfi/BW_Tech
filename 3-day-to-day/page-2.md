...
### 🧚‍♀️ 2. Cubby Nook, Fairy Cupboards, Living Room Nooks
...
Confirm panel displays OBS and on NX Witness Experience screen\
If not displaying:\
Open Task Manager → End OBS.exe → Relaunch OBS
...
📝 Must be completed before first show to clear messages and avoid confusion.
...
* If not already on, in ShowTouch OPS Panel → Technical > Lighting - Set to Pav 2 Work
...
* **Dome Monitor:**
  * Launch Nestmap (Dome projector program)
  * Launch Resolume (Dome content playback)\
    ⚙️ Shortcuts on desktop in Dome PC Showfiles box
* **Creek Monitor:**
  * Launch MadMapper
  * Ensure output set to Fullscreen
  * Launch Perform\
    ⚙️ Shortcuts on Creek _is there info missing here?_

**Dome Adjustments:**

* 🔄 Rotate Dome content or mask as needed
  * Floppy scene is to be centred between exit archway and Projector Plinth 5
* 🔊 Test AV sync
* 💡 Turn ON Dome LED after calibration
...
* External Box Office TV (Community Noticeboard): Displays postcard slideshow
* Internal Box Office TV: Displays tourism + sponsor slideshow
...
⚠️ DO NOT press physical button within 10 minutes of first scheduled show

* Button has been formatted to not trigger show again until 10 minute gap
